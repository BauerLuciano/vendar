...
const links = [
    ...
    { nombre: 'Punto de Venta', ruta: 'pos.index', icono: 'pos' }, // La caja siempre a mano arriba
    { nombre: 'Historial de Ventas', ruta: 'ventas.index', icono: 'ventas' }, 
    { nombre: 'Ingresos de Stock', ruta: 'ingresos.index', icono: 'ingresos' }, // <-- NUEVO
    ...
    { nombre: 'Proveedores', ruta: 'proveedores.index', icono: 'proveedores' }, // <-- NUEVO
...
<style scoped>
/* Opcional: Un pequeño scrollbar custom para que la barra lateral quede prolija si tienen muchos items */
