...
// ✨ 3. Limpieza Inteligente: ¿La sección entera tiene algo para mostrar?
const seccionVisible = (seccion) => {
    if (seccion.roles.length > 0 && !tieneAcceso(seccion.roles)) return false;
    return seccion.enlaces.some(item => 
        tieneAcceso(item.roles) && moduloHabilitado(item.modulo)
    );
};
...
const menu = [
    {
        ...
        roles: [], 
        enlaces: [
            { nombre: 'Dashboard', ruta: 'dashboard', icono: 'dashboard', roles: [], atajo: 'F1' },
        ]
    },
    {
        titulo: 'Comercial',
    ...
    },
    {
        ...
        enlaces: [
            { nombre: 'Transferencias', ruta: 'transferencias.index', icono: 'transferencias', roles: ['Encargado', 'SuperAdmin'], modulo: 'transferencias' },
            { nombre: 'Reposición', ruta: 'reposicion.index', icono: 'reposicion', roles: ['Encargado', 'SuperAdmin'], modulo: 'proveedores' },
            { nombre: 'Órdenes de Compra', ruta: 'ordenes-compra.index', icono: 'ordenes', roles: ['Encargado', 'SuperAdmin'], modulo: 'proveedores' },
            { nombre: 'Ingresos de Stock', ruta: 'ingresos.index', icono: 'ingresos', roles: ['Encargado', 'SuperAdmin'], modulo: 'proveedores' },
    ...
    },
    {
        ...
        enlaces: [
            ...
            { nombre: 'Facturación ARCA', ruta: 'configuracion.fiscal.wizard', icono: 'arca', roles: ['SuperAdmin'] },
            { nombre: 'Diagnóstico Fiscal', ruta: 'configuracion.fiscal.diagnostico', icono: 'diagnostico', roles: ['SuperAdmin'] },
    ...
    <div class="w-64 bg-slate-900 h-full shadow-2xl flex flex-col z-50"> 
        ...
        <nav class="flex-1 px-4 py-6 space-y-4 overflow-y-auto font-sans custom-scrollbar">
            <template v-for="seccion in menu" :key="seccion.titulo">
                ...
                <div v-if="seccionVisible(seccion)" class="space-y-1">
                        ...
                        <template v-for="item in seccion.enlaces" :key="item.nombre">
                            ...
                            >
                                <span class="w-5 h-5 flex items-center justify-center">
                                    ...
                                    <svg v-if="item.icono === 'reportes'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg>
                                    <svg v-if="item.icono === 'pedidos_web'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" /></svg>
                                    ...
                                    <svg v-if="item.icono === 'lotes'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
